 ...
 *
 * Bruk dokumentasjonen til å finne ut hvordan du bruker funksjonene:
 ...
 * Skriv ut resultatet av den nye variabelen til terminalen.
 */

const incrementingNumbers = [1, 2, 3, 4, 5];
...
const names = ['Ola', 'Kari', 'Per', 'Pål', 'Mari', 'Espen'];
...
const expenses = [200, 300, 400, 500, 600];
 ...
 *
 * For å akkessere et element i en liste(array) bruker du indeksering.
 * For å hente ut første element bruker du indeksen 0.
 * listen[index] gir deg elementet på plassen index i listen.
 */
